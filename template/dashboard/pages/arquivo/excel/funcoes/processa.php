...
$query = mysqli_query($CONNECTIONINCLUDE, "SELECT *,SUM(litros) AS somaselitros, SUM(valor) AS somasevalor FROM `tb_export` WHERE mes='$MES' AND safra='$SAFRA' ORDER BY `id_export` ASC");
$row1 = mysqli_num_rows($query);
if ($row1 > 0){
  while($sqline = mysqli_fetch_array($query)){
    $somalitros = $sqline['somaselitros'];
    $somavalor = $sqline['somasevalor'];
    }
  }
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>SistemaGSG | Baixar Excel</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="../../../arquivo/excel/" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Conciliar Funcionários</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<?php  
    ...
    $SQL_SELECT = "SELECT EXP.*,FUNC.nome_funcionario,FUNC.func_matricula,safra.inicio,mes.descricao_mes FROM tb_export AS EXP LEFT JOIN tb_funcionario AS FUNC ON EXP.funcionario=FUNC.cod_veiculo LEFT JOIN tb_safra as safra on exp.safra=safra.id_safra left join tb_mes as mes on exp.mes=mes.id_mes WHERE exp.mes='$MES' AND exp.safra='$SAFRA' ORDER BY FUNC.nome_funcionario ASC";
...
<form method="POST" action="functions.php">
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Baixar arquivos</h3>
    </div>
    ...
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        while ($SQL = $resultado_conexao->fetch(PDO::FETCH_ASSOC)): ?>
                <tr>
                  <?php $id = $SQL['id_export'];  ?>
                    <td><center><?php echo $SQL['func_matricula']; ?></center></td>
                    <td><center><?php echo $SQL['nome_funcionario']; ?></center></td>
                    <td><center><?php echo $SQL['descricao_mes']; ?></center></td>
                    <td><center><?php echo $SQL['inicio']; ?></center></td>
                    <td><center><?php echo date("d/m/Y",strtotime($SQL['date'])); ?></center></td>
                    <td><center><?php echo number_format($SQL['litros'],2,',','.'); ?></center></td>
                    <td><center><?php echo number_format($SQL['valor'],2,',','.'); ?></center></td>
        ...
        <tr>
          ...
          <th><center> </center></th>
          <th><center> </center></th>
          <th><center><?php echo number_format($somalitros,2,',','.'); ?></center></th>
          <th><center><?php echo number_format($somavalor,2,',','.'); ?></center></th>
          <th><center> <center></th>
        </tr>
        </tfoot>
      </table>
