...
<?php 
$MES=$_POST['Selectperiodo'];

$query = mysqli_query($CONNECTIONINCLUDE, "SELECT *,SUM(litros) AS somaselitros, SUM(valor) AS somasevalor FROM `tb_export_fornecedor_cana` WHERE date='$MES' ORDER BY `id_export` ASC");
