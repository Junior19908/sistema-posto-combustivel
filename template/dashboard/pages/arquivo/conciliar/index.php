...
<head>
  ...
  <title>SistemaGSG | Conciliar Funcionários</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="default.php" class="nav-link">Fornecedor de Cana</a>
      </li>
    </ul>
  ...
  <div class="content-wrapper">
    ...
    <form name="formCad" action="funcoes/processa.php" method="post">
      <div class="card-body">
        ...
        <div class="form-group">
            <label for="InputCalendario">Seleção de Mês</label>
            <select class="form-control" name="SelectMes" id="SelectMes">
              <?php echo($option2); ?>
            </select>
        </div>
        <div class="form-group">
            <label for="InputCalendario">Seleção de Safra</label>
            <select class="form-control" name="SelectSafra" id="SelectSafra">
              <?php echo($option3); ?>
            </select>
        </div>
      </div>
        <div class="card-footer">
            <button type="submit" name="#" class="btn btn-success toastsDefaultSuccess">Enviar</button>
        </div>
    </form>
    <!-- /.card-body -->
  </div>
...
<!-- Fim -->
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2019 <a href="#">SistemaGSG</a>.</strong>
    All rights reserved.
