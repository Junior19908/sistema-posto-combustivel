...
<head>
  ...
  <title>SistemaGSG | Visitas ao SistemaGSG</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="http://10.2.1.83:8035/SistemaGSGv2.0/template/dashboard/" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-success elevation-4">
    <!-- Brand Logo -->
    <a href="http://10.2.1.83:8035/SistemaGSGv2.0/template/dashboard/" class="brand-link">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./http://10.2.1.83:8035/SistemaGSGv2.0/template/dashboard/" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dashboard v3</p>
                </a>
              </li>-->
...
<?php  
    ...
    $SQL_SELECT = "SELECT vist.*,users.nome_user,users.avatar FROM `tb_visitas` AS vist LEFT JOIN tb_user AS users ON vist.id_user=users.id_user ORDER BY vist.date DESC";
...
?>
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Visitas ao SistemaGSG</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <th><center>Porta</center></th>
          <th><center>Data</center></th>
          <th><center>Hora</center></th>
          <th><center>PC</center></th>
        ...
        while ($SQL = $resultado_conexao->fetch(PDO::FETCH_ASSOC)): ?>
                <tr>
                    <td><center><?php echo $SQL['ip']; ?></center></td>
                    <td><center><?php echo $SQL['porta']; ?></center></td>
                    <td><center><?php echo date("d/m/Y",strtotime($SQL['date'])); ?></center></td>
                    <td><center><?php echo $SQL['time']; ?></center></td>
                    <td><center><?php echo $SQL['name']; ?></center></td>
                    <td><center><?php echo $SQL['nome_user']; ?></center></td>
                    <td><center><div class="image">
                      <img src="../../../dist/img/<?php echo $SQL['avatar']; ?>" class="img-circle elevation-2" alt="User Image" height="50" width="50">
                    </div></center></td>
                </tr>
              <?php endwhile; ?>
        </tbody>
