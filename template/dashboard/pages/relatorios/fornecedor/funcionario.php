  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../funcionarios/" class="nav-link">Voltar</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Relatório por Fornecedor</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- /.content-header -->
  ...
  <div class="card card-success">
    ...
    <form name="formCad" action="RelatorioFuncionario.php" method="post">
      <div class="card-body">
      <div class="form-group">
            <label for="InputCalendario">Seleção de Funcionários</label>
            <select class="form-control" name="SelectFunc" id="SelectFunc">
