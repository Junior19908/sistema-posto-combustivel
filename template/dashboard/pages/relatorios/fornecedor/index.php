...
<head>
  ...
  <title>SistemaGSG | Relatório de Fornecedor</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="fornecedor.php" class="nav-link">Consulta por Fornecedor</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="funcionario.php" class="nav-link">Consulta por Funcionário</a>
      </li>
    </ul>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../fornecedor/" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Relatório de Fornecedores</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- /.content-header -->
  ...
  <div class="card card-success">
    ...
    <form name="formCad" action="RelatorioFornecedor.php" method="post">
      <div class="card-body">
