...
<head>
  ...
  <title>SistemaGSG | Relatório Diretoria</title>
  ...
  <script>
    $(function() {
        $( "#calendarioINICIO" ).datepicker({ dateFormat: 'yy-mm-dd'}).val();
    });
    $(function() {
        $( "#calendarioFIM" ).datepicker({ dateFormat: 'yy-mm-dd'}).val();
    });
    </script>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../diretoria/" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Relatório Diretoria</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- /.content-header -->
  ...
  <div class="card card-success">
    ...
    <form name="formCad" action="RelatorioDiretoria.php" method="post">
      <div class="card-body">
        <div class="form-group">
            <label for="InputCalendario">Data</label>
            <input type="text" class="form-control" name="calendarioINICIO" id="calendarioINICIO" placeholder="Data do Movimento Inicio">
            <input type="text" class="form-control" name="calendarioFIM" id="calendarioFIM" placeholder="Data do Movimento Fim">
        </div>
      <div class="form-group">
            <label for="InputCalendario">Seleção de Combustível</label>
            <select class="form-control" name="SelectComb" id="SelectComb">
              <option value="404">Diesel S10</option>
              <option value="403">Gasolina</option>
            </select>
        </div>
      <div class="form-group">
            <label for="InputCalendario">Seleção de Destino</label>
            <select class="form-control" name="SelectDest" id="SelectDest">
              <option value="1">Próprio</option>
              <option value="2">Fornecedor de Cana</option>
              <option value="3">Funcionários</option>
            </select>
        </div>
      </div>
        <div class="card-footer">
            <button type="submit" name="btnMovimentos" class="btn btn-success toastsDefaultSuccess">Gerar</button>
        </div>
    </form>
    <!-- /.card-body -->
  </div>
