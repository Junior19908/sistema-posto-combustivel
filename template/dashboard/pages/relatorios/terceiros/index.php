...
<head>
  ...
  <title>SistemaGSG | Relatório Terceiros</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../terceiros/" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Conferência de Terceiros</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<!-- /.content-header -->
  ...
  <div class="card card-success">
    ...
    <form name="formCad" action="RelatorioTerceiros.php" method="post">
      <div class="card-body">
      <div class="form-group">
            <label for="InputCalendario">Seleção</label>
