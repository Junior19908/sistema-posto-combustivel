...
<head>
    ...
    <title>SistemaGSG | Evento NF</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Evento NF</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="Evento" placeholder="NOTA FISCAL"></input>
                            </div>
                        </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" name="btnEventoNF" class="btn btn-warning toastsDefaultSuccess">Registrar</button>
                    </div>
                </form>
                <!-- /.card-body -->
            </div>
