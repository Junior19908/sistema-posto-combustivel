          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Acesso Balança</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
      ...
      <div class="card-header">
        ...
        <div class="card-body">
          <center>
              ...
              <br>
                  <a href="RelatorioAcesso.php" class="btn btn-warning" >Gerar PDF</a>
              <br>
        </center>
      </div>
    </div>
      ...
      <div class="card-header">
        ...
        <div class="card-body">
          <center>
              ...
              <br>
                  <a href="RelatorioCheckList.php" class="btn btn-warning" >Gerar PDF</a>
              <br>
        </center>
      </div>
    </div>
