...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <div class="input-group input-group-sm">
        ...
        <div class="content-wrapper">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Lista de Ordens - ZSD014</h3>
              </div>
              <!-- /.card-header -->
                ...
                <table class="table table-condensed">
                  <thead>
                    ...
                    <?php  
                        ...
                        $SQL_SELECT = "SELECT * FROM tb_saida_semana ORDER BY DATA_EMISS DESC LIMIT 1000";
                  ...
                  <tbody id="myTable">
                    ...
                    while ($SQL = $resultado_conexao->fetch(PDO::FETCH_ASSOC)): ?>
                        ...
                        ?>
                            <tr>
                                <td style="text-align: left;"><?php echo $SQL['COD_RECEB']; ?></td>
                                <td style="text-align: center;"><?php echo $SQL['ORDEM']; ?></td>
                                <td style="text-align: center;"><?php echo $SQL['PEDIDO']; ?></td>
                                <td style="text-align: center;"><?php echo $SQL['MATERIAL']; ?></td>
                                <td style="text-align: right;"><?php echo number_format($QUANTIDADE, 0, ',', '.'); ?></td>
                                <td style="text-align: right;"><?php echo $SQL['UNIDADE']; ?></td>
                                <td style="text-align: center;"><?php echo date("d/m/Y",strtotime($SQL['DATA_EMISS'])); ?></td>
                                  <!--<td>
                                  ...
                                  data-iov="<?php echo $SQL['ID_SAIDA']; ?>"
                                  data-nm="<?php echo $SQL['COD_RECEB']; ?>"
                                  data-ov="<?php echo $SQL['ORDEM']; ?>"
                                  data-qt="<?php echo $SQL['QUANTIDADE']; ?>"
                                  data-umb="<?php echo $SQL['UNIDADE']; ?>"
                                  data-istfs="<?php echo $SQL['SAFRA']; ?>"
                                  data-pdn="<?php echo $SQL['PEDIDO']; ?>"
                                  data-pfd="<?php echo $SQL['col_status']; ?>"
                                  >Alterar</button>
                                  <td><button type="button" class="btn btn-xs btn-danger" data-toggle="modal" data-target="#ModalDeletar" data-iov="<?php echo $SQL['ID_SAIDA']; ?>" data-ov="<?php echo $SQL['ORDEM']; ?>">Excluir</button></td></tr>
                    <?php endwhile; ?>
                  </tbody>
                </table>
              </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="recipient-StatusP" class="col-form-label">Exibir no Relatório de Saídas da Semana?</label>
                        <select name="StatusP" class="form-control" id="StatusP">
                ...
                <button type="submit" name="btnUpdateOvSaida" class="btn btn-outline-light">Alterar</button>
                </div>
            </form>
            </div>
            </div>
    ...
    $('#gsgModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#StatusP').val(StatPDF)
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="btnDeleteOvSaida" class="btn btn-primary">Sim</button>
      </div>
    </div>
    </form>
  </div>
