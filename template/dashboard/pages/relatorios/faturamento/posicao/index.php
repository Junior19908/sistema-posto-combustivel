    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="lista/" class="nav-link">Banco de Dados</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="mercinter-exter/" class="nav-link">Merc. Inter/Exter</a>
                </li>
            </ul>
            <!-- Right navbar links -->
      ...
      <div class="card card-warning">
        ...
        <div class="card-body">
        <form name="formCad" action="RelatorioPosicaoSemana.php" method="post">
            <div class="form-group">
              <label for="InputCalendario">Seleção de Periodo</label>
              <input type="text" class="form-control" name="calendarioINICIO" value="<?php echo($DT_INICIO); ?>" id="calendarioINICIO" placeholder="Data do Movimento Inicio">
              <input type="text" class="form-control" name="calendarioFIM" value="<?php echo($DT_FIM___); ?>" id="calendarioFIM" placeholder="Data do Movimento Fim">
            </div>
			  <div class="form-group">
				<label for="InputCalendario">Safra</label>
				<select class="form-control" name="safra" id="safra">
                   <option value="4">2019/2020</option>
                   <option value="5" selected>2020/2021</option>
                   <option value="6">2021/2022</option>
				</select>
                </div>
                <div class="custom-control custom-switch custom-switch-off-danger custom-switch-on-success">
                    <input type="checkbox" class="custom-control-input" id="customSwitch3">
                    <label class="custom-control-label" for="customSwitch3">Virar Posição?</label>
                </div>
          </div>
