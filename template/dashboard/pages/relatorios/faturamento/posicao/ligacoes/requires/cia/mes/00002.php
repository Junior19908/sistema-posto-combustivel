<?php
        ...
        if ($CONSULT > 0) {
            ...
            $SM00002 =  ($QTDCONTRATO00002KG + $QTDCONTRATO00002) - ($Q00002 + $Q00002KG);
    ...
    $QUERYMYSQL = mysqli_query($CONNECTIONFATURAMENTO, "SELECT * FROM tb_contratos WHERE col_position='00002' AND col_repres='1' AND SAFRA='$SAFRA' ORDER BY `col_nome` ASC");
    $CONSULTMYSQL = mysqli_num_rows($QUERYMYSQL);

    if ($CONSULTMYSQL > 0) {
        $QUERY2 = mysqli_query($CONNECTIONFATURAMENTO, "SELECT * FROM `tb_contratos` WHERE col_position='00002' AND col_repres='1' AND SAFRA='$SAFRA'");
