        ...
        <div class="content-wrapper">
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Inserir Informações - Interno</h3>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="contrato" placeholder="Contrato"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="pedido" placeholder="Pedido"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="quantidade" placeholder="Quantidade"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="faturado" placeholder="Faturado"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="a_faturar" placeholder="A Faturar"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="entregue" placeholder="Entregue"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="a_entregar" placeholder="Á Entregar"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="data_dia" name="data_dia" placeholder="Data"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <select name="acucar" class="form-control" id="acucar">
                                    <option value="24">Açúcar Cristal</option>
                                    <option value="18">Açúcar VHP</option>
                                </select>
                            </div>
                        </div>
                        </div>
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">Inserir Informações - Externo</h3>
                </div>
                    <div class="card-body">
                        <div class="row">
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="ex_contrato" placeholder="Contrato"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="ex_pedido" placeholder="Pedido"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="ex_quantidade" placeholder="Quantidade"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="ex_faturado" placeholder="Faturado"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="ex_a_faturar" placeholder="A Faturar"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="ex_entregue" placeholder="Entregue"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="ex_a_entregar" placeholder="Á Entregar"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="ex_data_dia" name="ex_data_dia" placeholder="Data"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <select name="ex_Safra" class="form-control" id="ex_Safra">
                                    <option value="5">2020/2021</option>
                                    <option value="6">2021/2022</option>
                                    <option value="7">2022/2023</option>
                                </select>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <select name="ex_acucar" class="form-control" id="ex_acucar">
                                    <option value="24">Açúcar Cristal</option>
                                    <option value="18">Açúcar VHP</option>
                                </select>
                            </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" name="btnInsertMercInterExtern" class="btn btn-warning toastsDefaultSuccess btn-lg">Registrar</button>
                    </div>
                </form>
                <!-- /.card-body -->
            </div>
