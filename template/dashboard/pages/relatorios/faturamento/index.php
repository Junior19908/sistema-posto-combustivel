...
<head>
  ...
  <title>SistemaGSG | Relatório de Faturamento</title>
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="fila/" class="nav-link">Fila de Carregamento</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="lpd/" class="nav-link">LPD - Livro de Produção Diário</a>
        </li>
  		<li class="nav-item d-none d-sm-inline-block">
  		  <a href="posicao/" class="nav-link">Posição de Açúcar</a>
  		</li>
        <li class="nav-item d-none d-sm-inline-block">
          <a href="acesso/" class="nav-link">Acesso Balança</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
          <a href="cbio/" class="nav-link">Notas Fiscais - CBIO</a>
      </li>
      </ul>
      <!-- Right navbar links -->
    ...
    <aside class="main-sidebar sidebar-dark-success elevation-4">
      ...
      <a href="index3.html" class="brand-link">
        <img src="../../../dist/img/LogoUSGA.png" alt="USGA Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Posição Semanal</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <div class="card card-warning">
        ...
        <form name="formCad" action="RelatorioSaidaSemana.php" method="post">
          <div class="card-body">
            <div class="form-group">
              <label for="InputCalendario">Seleção de Periodo</label>
          ...
          <div class="card-footer">
            <button type="submit" name="btnMovimentos" class="btn btn-warning toastsDefaultSuccess">Gerar PDF</button>
          </div>
        </form>
        <!-- /.card-body -->
      </div>
