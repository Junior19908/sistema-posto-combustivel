...
<head>
  ...
  <title>SistemaGSG | Fila de Carregamento</title>
    ...
    <div class="content-wrapper">
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Fila de Carregamento</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <div class="card card-warning">
        <div class="card-header">
          <h3 class="card-title">Inserir Informações</h3>
        </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <input type="number" class="form-control" name="VeiculoArmazem" placeholder="Veículos no Armazém"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <!-- Direita -->
                <div class="form-group">
                  <input type="number" class="form-control" name="VeiculoPatio" placeholder="Veículos no Pátio"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input type="number" class="form-control" name="SacariaArmazem" placeholder="Sacarias"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <!-- Direita -->
                <div class="form-group">
                  <input type="number" class="form-control" name="SacariaPatio" placeholder="Sacarias"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input type="number" class="form-control" name="BigBagArmazem" placeholder="Big-Bag"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <!-- Direita -->
                <div class="form-group">
                  <input type="number" class="form-control" name="BigBagPatio" placeholder="Big-Bag"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
                  <input type="number" class="form-control" name="AnidroArmazem" placeholder="Anidro"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <!-- Direita -->
                <div class="form-group">
                  <input type="number" class="form-control" name="AnidroPatio" placeholder="Anidro"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <!-- Direita -->
                <div class="form-group">
                  <input type="number" class="form-control" name="HidratadoArmazem" placeholder="Hidratado"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <!-- Direita -->
                <div class="form-group">
                  <input type="number" class="form-control" name="HidratadoPatio" placeholder="Hidratado"></input>
                </div>
              </div>
              <div class="col-sm-6">
                <!-- Direita -->
                <div class="form-group">
                <input type="text" class="form-control" name="periodo" id="periodo" placeholder="Data">
                </div>
              </div>
            </div>
          </div>
          <div class="card-footer">
            <button type="submit" name="btnFilaCarregamento" class="btn btn-warning toastsDefaultSuccess">Gravar</button>
          </div>
        </form>
        <!-- /.card-body -->
      </div>
