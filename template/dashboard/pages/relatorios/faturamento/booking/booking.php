...
if($rowNavio == 0){
    echo '<head>
            <script type="text/javascript">alert("Não Há Booking Criado!")</script>
            <meta http-equiv="refresh" content="0;url='. $linkBookingInserir .'" />
        </head>';
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>SistemaGSG | Inserir Booking</title>
            ...
            <div class="card card-warning">
                ...
                <form name="formCad" action="" method="post">
                    <div class="card-body">
                        ...
                        if ($rowNavio > 0) {
                            while ($sqline = mysqli_fetch_array($queryNavio)) {
                                $NAVIO = $sqline['col_navio'];
                                $BOOKING = $sqline['col_Booking'];
                            }
                        }
                        ?>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="Navio" value="<?php echo ($NAVIO); ?>"></input>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="Booking" value="<?php echo ($BOOKING); ?>"></input>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="Containers" placeholder="Containers"></input>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="Situacao" placeholder="Situação"></input>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="ContainersN" placeholder="ContainersN"></input>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="SituacaoN" placeholder="SituaçãoN"></input>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="DataBooking" id="dataBooking" placeholder="Data do Booking"></input>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="DataPeriodo" id="dataPeriodo" placeholder="Data do Periodo"></input>
                                </div>
                            </div>
                        </div>
                        <center><label for="InputBomba1">Deseja Finalizar?</label></center>
                    ...
                    <div class="card-footer">
                        <button type="submit" name="btnBookingManual" class="btn btn-warning toastsDefaultSuccess">Registrar</button>
                    </div>
                </form>
                <!-- /.card-body -->
            </div>
