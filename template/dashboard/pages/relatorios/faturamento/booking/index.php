                        ...
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-ship" aria-hidden="true"></i></span>
                                </div>
                                <input type="text" class="form-control" name="Navio" placeholder="MSC CORUNA MM651R"></input>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-file-contract" aria-hidden="true"></i></span>
                                </div>
                                <input type="text" class="form-control" name="Booking" placeholder="241ISZ0904086"></input>
                            </div>
                        </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" name="btnBooking" class="btn btn-warning toastsDefaultSuccess">Registrar</button>
                    </div>
                </form>
                <!-- /.card-body -->
            </div>
