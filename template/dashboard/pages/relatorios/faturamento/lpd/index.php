...
<head>
    ...
    <title>SistemaGSG | Relatório LPD</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Livro de Produção Diário</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="card card-warning">
                ...
                <form name="formCad" action="RelatorioLPD.php" method="post">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="Selectperiodo" id="Selectperiodo">
                        ...
                        <div class="form-group">
                            <label for="InputCalendario">Safra Velha?</label>
                            <select class="form-control" name="safraVelha" id="safraVelha">
