...
<head>
  ...
  <title>SistemaGSG | Entrada de Bombas</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Bombas</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <form role="form" name="formCad" action="" method="post">
            ...
            <?php require_once '../../../../controller/user.php'; ?>
                <div class="form-group">
                    <label for="InputBomba1">Bomba 1</label>
                    <input type="text" class="form-control" name="bomba1" id="bomba1" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputBomba2">Bomba 2</label>
                    <input type="text" class="form-control" name="bomba2" id="bomba2" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputBomba3">Bomba 3</label>
                    <input type="text" class="form-control" name="bomba3" id="bomba3" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputBomba4">Bomba 4</label>
                    <input type="text" class="form-control" name="bomba4" id="bomba4" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputBomba5">Bomba 5</label>
                    <input type="text" class="form-control" name="bomba5" id="bomba5" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputBomba6">Bomba 7</label>
                    <input type="text" class="form-control" name="bomba6" id="bomba6" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputBomba7">Bomba 8</label>
                    <input type="text" class="form-control" name="bomba7" id="bomba7" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputCalendario">Data</label>
                    <input type="text" class="form-control" name="calendario" id="calendario" placeholder="Data da Leitura">
                </div>
                <input type="text" name="id_user" hidden="" value="<?php echo($id_userr) ?>">
                <div class="card-footer">
                    <button type="submit" id="toastsDefaultSuccess" name="btnBombas" onClick="process()" class="btn btn-success toastsDefaultSuccess">Enviar</button>
                </div>
            </div>
        </form>
    </div>
