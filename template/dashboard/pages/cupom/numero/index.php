...
<div class="wrapper">
  ...
  <div class="card card-success">
    <div class="card-header">
      <h3 class="card-title">Seleção por Cupom</h3>
    </div>
    <form name="formCad" action="funcoes/processa.php" method="post">
      <div class="card-body">
        <div class="form-group">
            <label for="InputCalendario">Cupom</label>
            <input type="text" class="form-control" name="id_cupom" placeholder="Insira o Número do Cupom">
        </div>
      </div>
