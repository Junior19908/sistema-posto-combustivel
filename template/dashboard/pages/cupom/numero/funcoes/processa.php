...
if(!isset($_POST['id_cupom']) == true){
  echo'<head>
          <script type="text/javascript">alert("Retornando!")</script>
          <meta http-equiv="refresh" content="0;url=http://10.2.1.4/SistemaGSGv2.0/template/dashboard/pages/cupom/data/" />
      </head>';
}else{
...
<!-- Main content -->
<?php
    $CUPOM=$_POST['id_cupom'];
    // abre a conexão
    $PDO = ConexaoDB();
    // SQL para selecionar os registros
    $SQL_SELECT = "SELECT * FROM tb_import WHERE id_cupom = '$CUPOM'";
...
?>
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Lista de Cupom</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
