  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../alterar-cadastro-cupom/" class="nav-link">Cupons Rejeitados</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <form name="formCad" action="funcoes/processa.php" method="post">
      <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="calendarioINICIO" id="calendarioINICIO" required placeholder="Data Inicio">
            <input type="text" class="form-control" name="calendarioFIM" id="calendarioFIM" required placeholder="Data Fim">
        </div>
      </div>
        <div class="card-footer">
            <button type="submit" name="btn" class="btn btn-success toastsDefaultSuccess">Enviar</button>
        </div>
    </form>
    <!-- /.card-body -->
  </div>
