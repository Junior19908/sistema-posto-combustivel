...
if(!isset($_POST['calendarioINICIO']) == true){
    echo'<head>
            <script type="text/javascript">alert("Retornando!")</script>
            <meta http-equiv="refresh" content="0;url=http://usga-servidor-m/SistemaGSGv2.0/template/dashboard/pages/cupom/data/" />
        </head>';
}else{
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="../" class="nav-link">Cupom por Data</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
...
<?php
    ...
    $SQL_SELECT = "SELECT * FROM tb_import WHERE date BETWEEN '$dataInicio' AND '$dataFim'";
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        while ($SQL = $resultado_conexao->fetch(PDO::FETCH_ASSOC)): ?>
                <tr>
                    ...
                    <td><center><?php echo $SQL['cod_produto']; ?></center></td>
                    ...
                    <td><center><?php echo $SQL['funcionario_cod_veiculo']; ?></center></td>
    ...
    <div class="modal-content bg-success">
      ...
      <div class="modal-body">
        <form role="form" name="formCad" action="" method="post">
          ...
          <div class="form-group">
              <label for="recipient-TextoMotiv" class="col-form-label">Motivação:</label>
