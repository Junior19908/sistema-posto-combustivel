...
<head>
  ...
  <title>SistemaGSG | Registrar Cupom</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="../arquvio/conciliar/" class="nav-link">
                  <i class="fas fa-file-alt nav-icon"></i>
                  <p>Conciliar</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="../arquvio/excel/" class="nav-link">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Registrar Cupom</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Registro de Cupom Avulso</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" name="formCad" action="" method="post">
            ...
            <?php require_once '../../../../controller/user.php'; ?>
                <div class="form-group">
                    <label for="InputCupom">Cupom</label>
                    <input type="text" class="form-control" name="Cupom" placeholder="Digite o Nº do Cupom">
                </div>
                <div class="form-group">
                    <label for="InputVeiculo">Veículo</label>
                    <input type="text" class="form-control" name="Veiculo" placeholder="Digite o Nº do Veículo">
                </div>
                <div class="form-group">
                    <label for="InputQuilometragem">Quilometragem</label>
                    <input type="text" class="form-control" name="Quilometragem" placeholder="Digite a Quilometragem do Veículo">
                </div>
                <div class="form-group">
                    <label for="InputBomba">Bomba</label>
                    <input type="text" class="form-control" name="Bomba" placeholder="Digite o Nº do Bico">
                </div>
                <div class="form-group">
                    <label for="InputServiço">Serviço</label>
                    <input type="text" class="form-control" name="Servico" placeholder="Digite o Código do Serviço">
                </div>
                <div class="form-group">
                    <label for="InputLitros">Litros</label>
                    <input type="text" class="form-control" name="Litros" placeholder="Digite a Quantidade">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="InputValor">Produto</label>
                ...
                <div class="form-group">
                    <label for="InputCalendario">Data</label>
                    <input type="text" class="form-control" name="calendario" id="calendario" placeholder="Data do Cupom">
                </div>
                <div class="form-group">
                    <label for="InputHora">Hora</label>
                    <input type="time" step="1" class="form-control" name="Hora" placeholder="Digite de a hora inserção do Cupom">
                </div>
                <input type="text" name="User" hidden="" value="<?php echo($id_userr) ?>">
                <div class="card-footer">
                    <button type="submit" name="btnEnviarCupom" class="btn btn-success toastsDefaultSuccess">Enviar</button>
                </div>
            </div>
        </form>
    </div>
