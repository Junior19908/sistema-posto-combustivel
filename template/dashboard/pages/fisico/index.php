...
<head>
  ...
  <title>SistemaGSG | Entrada do Estoque Fisico</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../fisico/" class="nav-link active">
                <i class="fas fa-gas-pump"></i>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../import/propprio/" class="nav-link">
                  <i class="fas fa-server nav-icon"></i>
                  <p>Próprio</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Estoque Físico</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <form role="form" name="formCad" action="" method="post">
            ...
            <?php require_once '../../../../controller/user.php'; ?>
                <div class="form-group">
                    <label for="InputTanque1">Tanque 1</label>
                    <input type="text" class="form-control" name="tanque1" id="tanque1" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputTanque2">Tanque 2</label>
                    <input type="text" class="form-control" name="tanque2" id="tanque2" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputTanque3">Tanque 3</label>
                    <input type="text" class="form-control" name="tanque3" id="tanque3" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputTanque4">Tanque 4</label>
                    <input type="text" class="form-control" name="tanque4" id="tanque4" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputTanque5">Tanque 5</label>
                    <input type="text" class="form-control" name="tanque5" id="tanque5" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                    <label for="InputTanque6">Tanque 6</label>
                    <input type="text" class="form-control" name="tanque6" id="tanque6" placeholder="Digite a Leitura">
                </div>
                <div class="form-group">
                ...
                <div class="card-footer">
                    <button type="submit" name="btnTanque" class="btn btn-success toastsDefaultSuccess">Enviar</button>
                </div>
            </div>
        </form>
    </div>
