...
<head>
  ...
  <title>SistemaGSG | Importar Cupom</title>
...
<div class="wrapper">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../../import/cupom/" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-success">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form role="form" method="POST" action="funcoes/processa.php" enctype="multipart/form-data">
        <div class="card-body">
		<h6>Último arquivo importado ref. ao dia - <?php echo date("d/m/Y",strtotime($VERIFICADATA)); ?></h6>
          <div class="form-group">
            <label for="exampleInputFile">Insira o Arquivo</label>
            <div class="input-group">
              <div class="custom-file">
                <input type="file" class="custom-file-input" name="arquivo" id="arquivo" multiple="multiple">
                <label class="custom-file-label" for="exampleInputFile">Caminho do Arquivo <a  title="Certifique-se de que os arquivos estarão no formato TXT" ></a></label>
              </div>
              <div class="input-group-append">
