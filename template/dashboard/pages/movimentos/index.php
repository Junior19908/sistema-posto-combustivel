...
<head>
  ...
  <title>SistemaGSG | Entrada de Movimentos</title>
    ...
    <div class="card card-success">
        ...
        <form role="form" name="formCad" action="" method="post">
            ...
            <?php require_once '../../../../controller/user.php'; ?>
                ...
                <div class="form-group">
                    <label for="InputAfericao">Aferição</label>
                    <input type="text" class="form-control" name="afericao" placeholder="Digite a Aferição">
                </div>
                <div class="form-group">
                    <label for="InputEntrada">Entradas</label>
                    <input type="text" class="form-control" name="entrada" placeholder="Digite a Entrada">
                </div>
                <div class="form-group">
                    <label for="InputNotaFiscal">Nota Fiscal</label>
                    <input type="text" class="form-control" name="NotaFiscal" placeholder="Digite o Nº: da Nota Fiscal">
                </div>
                <div class="form-group">
                    <label for="InputChaveAcesso">Chave Acesso</label>
                    <input type="text" class="form-control" name="ChaveAcesso" placeholder="Digite os 9 últimos números da Nota Fiscal">
                </div>                <div class="form-group">
                    <label for="InputManuEntrada">Manutenção de Entradas</label>
                    <input type="text" class="form-control" name="manute" placeholder="Digite a Manutenção da Entrada">
                </div>
                <div class="form-group">
                    <label for="InputManuSaida">Manutenção de Saídas</label>
                    <input type="text" class="form-control" name="manuts" placeholder="Digite a Manutenção de Saídas">
                </div>
                <div class="form-group">
                    <label for="InputCalendario">Data</label>
                    <input type="text" class="form-control" name="calendario" id="calendario" placeholder="Data do Movimento">
                </div>
                <input type="text" name="id_user" hidden="" value="<?php echo($id_userr) ?>">
                <div class="card-footer">
                    <button type="submit" name="btnMovimentos" class="btn btn-success toastsDefaultSuccess">Enviar</button>
                </div>
            </div>
        </form>
    </div>
