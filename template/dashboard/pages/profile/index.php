...
<head>
  ...
  <title>SistemaGSG | Perfil do Usuário</title>
              ...
              <div class="card-body box-profile">
                <div class="text-center">
                  <img class="profile-user-img img-fluid img-circle"
                       src="../../dist/img/<?php echo ''.$avatar.'' ?>"
                       alt="User profile picture">
                </div>

                <h3 class="profile-username text-center"><?php echo($nome); ?></h3>

                <p class="text-muted text-center"><?php if($id_userr == 1){
                    echo "Administrador";
                }elseif($id_userr == 2){
                    echo "Usuário Limitado";
                } ?></p>

                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Visitas ao SistemaGSG</b> <a class="float-right"><?php echo($visitasuser); ?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Transações executadas</b> <a class="float-right"><?php echo($Transacoes); ?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Cadastrado Desde</b> <a class="float-right"><?php echo date("d/m/Y",strtotime($DataCadastro)); ?></a>
                  </li>
                </ul>
              </div>
              <!-- /.card-body -->
