      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="../matricula/" class="nav-link active">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Criar Cadastro</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <div class="card card-success">
      <div class="card-header">
        ...
        <div class="card-body">
          <center>
                <label for="">Fornecedor/Funcionário/Proprio</label>
              <br>
                  <a href="geral/" class="btn btn-warning" >Criar</a>
              <br>
        </center>
      </div>
    </div>
  <!-- Fim da Div -->
    ...
    <div class="card card-success">
      <div class="card-header">
        ...
        <div class="card-body">
          <center>
                <label for="">Usuários do SistemaGSG</label>
              <br>
                  <a href="users/" class="btn btn-warning" >Criar</a>
              <br>
        </center>
      </div>
    </div>
