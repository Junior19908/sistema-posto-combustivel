...
<head>
  ...
  <title>SistemaGSG | Criar Cadastro</title>
  ...
  <div class="content-wrapper">
    ...
    <?php require_once '../../../../../controller/user.php'; ?>
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="name" id="name" placeholder="Digite o Nome Completo do Usuário">
      </div>
      <div class="form-group">
          <label for="Inputusername">Login: </label>
          <input type="text" class="form-control" name="username" id="username" placeholder="Digite o Login de Entrada no SistemaGSG">
      </div>
      <input type="text" hidden value="1" name="password" id="password">
      <div class="form-group">
          <label for="Inputregistration">Matricula: </label>
          <input type="text" class="form-control" name="registration" id="registration" placeholder="Digite a Matricula do Usuário">
      </div>
      <div class="form-group">
          <label for="SelectTypeUser">Tipo de Usuário: </label>
          <select name="SelectTypeUser" class="form-control" id="SelectTypeUser">
            <option value="1">Administrador</option>
            <option value="2">Usuário Limitado</option>
        </select>
      </div>
      <div class="form-group">
          <label for="SelectStatus">Status do Usuário: </label>
          <select name="SelectStatus" class="form-control" id="SelectStatus">
      ...
      <div class="card-footer">
          <button type="submit" name="btnCadastroUser" class="btn btn-success toastsDefaultSuccess">Enviar</button>
      </div>
    </div>
    </form>
</div>
