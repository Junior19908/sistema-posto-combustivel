...
<?php  
    ...
    $SQL_SELECT = "SELECT * FROM tb_user";
...
?>
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Usuários Cadastrados no SistemaGSG</h3>
    </div>
    <!-- /.card-header -->
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        while ($SQL = $resultado_conexao->fetch(PDO::FETCH_ASSOC)): ?>
                <tr>
                    <td><center><?php echo $SQL['id_user']; ?></center></td>
                    <td><center><?php echo $SQL['nome_user']; ?></center></td>
                    <td><center><?php echo $SQL['login_user']; ?></center></td>
                    <td><center><?php echo $SQL['regist_user']; ?></center></td>
                    <td><center><span class="badge badge-<?php if($SQL['status_user']==1){echo"success";}elseif($SQL['status_user']==2){echo"danger";}else{echo"other";}?>"><?php if($SQL['status_user']==1){
                      echo "Ativo";
                    }elseif($SQL['status_user']==2){
                      echo "Desativado";
                    }else{
                      echo  "Outro";
                    } ?></span></center></td>
                    <td><center><span class="badge badge-<?php if($SQL['type_user']==1){echo"success";}elseif($SQL['type_user']==2){echo"warning";}elseif($SQL['type_user']==3){echo"info";}elseif($SQL['type_user']==4){echo"danger";}else{echo"other";}?>"><?php if($SQL['type_user']==1){
                      echo "Administrador";
                    }elseif($SQL['type_user']==2){
                      echo "Posto de Combustível";
                    }elseif($SQL['type_user']==3){
                      echo "Almoxarifado";
                    }elseif($SQL['type_user']==4){
                      echo "Faturamento";
                    }else{
                      echo  "Outro";
                    } ?></span></center></td>
                    <td>
                      <center>
                        <button type="button" class="btn btn-xs btn-success" data-toggle="modal" data-target="#exampleModalUsina" data-userid="<?php echo $SQL['id_user']; ?>" data-nomeuser="<?php echo $SQL['nome_user']; ?>" data-loginuser="<?php echo $SQL['login_user']; ?>" data-registeruser="<?php echo $SQL['regist_user']; ?>" data-tipouser="<?php echo $SQL['type_user']; ?>" data-statususer="<?php echo $SQL['status_user']; ?>">Alterar</button>
                      </center>
                    </td>
                </tr>
              <?php endwhile; ?>
      ...
      <div class="modal-body">
        <form role="form" name="formCadUsina" action="" method="post">
          ...
          <div class="form-group">
              <label for="UserName" class="col-form-label">Nome do Usuário :</label>
              <input name="UserName"  type="text" class="form-control" id="UserName">
          </div>
          <div class="form-group">
              <label for="LoginUser" class="col-form-label">Login :</label>
              <input name="LoginUser"  type="text" class="form-control" id="LoginUser">
          </div>        
          <div class="form-group">
              <label for="MatriculaUser" class="col-form-label">Matricula :</label>
              <input name="MatriculaUser"  type="text" class="form-control" id="MatriculaUser">
          </div>
          <div class="form-group">
              <label for="StatusUser" class="col-form-label">Status :</label>
          ...
          <div class="form-group">
              <label for="TipoUser" class="col-form-label">Tipo :</label>
              <select  name="TipoUser"  class="form-control" id="TipoUser">
        ...
        <div class="modal-footer justify-content-between">
          ...
          <button type="submit" name="btnAlterarUser" class="btn btn-outline-light">Alterar</button>
        </div>
      </form>
    </div>
    <!-- /.modal-content -->
...
<script type="text/javascript">
    ...
    var NomeUser = button.data('nomeuser')
    var LoginUser = button.data('loginuser')
    var MatriculaUser = button.data('registeruser')
    ...
    var modal = $(this)
    modal.find('.modal-title').text('Id do Usuário Nº: ' + UserID)
    modal.find('#id').val(UserID)
    modal.find('#UserName').val(NomeUser)
    modal.find('#LoginUser').val(LoginUser)
    modal.find('#MatriculaUser').val(MatriculaUser)
    modal.find('#TipoUser').val(TipoUser)
    modal.find('#StatusUser').val(StatusUser)
  })
</script>
