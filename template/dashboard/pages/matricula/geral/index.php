...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Cadastro Func/Forn/Prop</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    ...
    <?php require_once '../../../../../controller/user.php'; ?>
      ...
      <div class="form-group">
          <label for="InputMatricula">Matricula/Código: </label>
          <input type="text" class="form-control" name="Matricula" id="Matricula" placeholder="Digite a Matricula ou Código">
      </div>
      <div class="form-group">
          <label for="InputVeiculo">Veículo: </label>
          <input type="text" class="form-control" name="Veiculo" id="Veiculo" placeholder="Digite o Veículo">
      </div>
      <div class="form-group">
          <label for="InputPlaca">Placa: </label>
          <input type="text" class="form-control" name="Placa" id="Placa" placeholder="Digite a Placa do Veículo">
      </div>
      <div class="form-group">
          <label for="InputFazenda">Fazenda: </label>
          <input type="text" class="form-control" name="Fazenda" id="Fazenda" placeholder="Digite o Nome da Fazenda">
      </div>
      <div class="form-group">
          <label for="InputContrato">Contrato: </label>
          <input type="text" class="form-control" name="Contrato" id="Contrato" placeholder="Digite o Contrato">
      </div>
      <input type="text" name="id_user" hidden="" value="<?php echo($id_userr) ?>">
      <div class="card-footer">
          <button type="submit" name="btnCadastro" class="btn btn-success toastsDefaultSuccess">Enviar</button>
      </div>
    </div>
    </form>
</div>
