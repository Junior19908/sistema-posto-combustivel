...
<head>
  ...
  <title>SistemaGSG | Criar Posições</title>
...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="../SolicReserva.php" class="nav-link">
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-success">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form role="form" method="POST" action="../relatorios/requires/processa.php" enctype="multipart/form-data">
        <div class="card-body">
          <div class="form-group">
            <label for="exampleInputFile">Criar Posição</label>
            <div class="form-group">
                <input type="number" class="form-control" name="posicao" id="posicao" placeholder="40xxx">
            </div>
          </div>
          <div class="form-group">
      </div>
