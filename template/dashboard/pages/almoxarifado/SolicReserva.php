...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <title>SistemaGSG | Buscar Reserva</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="SolicReserva.php" class="nav-link active">
                <i class="fas fa-people-carry"></i>
                  <p>Consultar Reserva SAP</p>
                </a>
              </li>
            </ul>
          </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-success">
        <div class="card-header">
            <h3 class="card-title">Buscar reserva no SAP</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" name="formCad" action="" method="post">          
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="Requisicao" placeholder="Digite aqui" required>
                    <div class="form-group">
                ...
                <div class="card-footer">
                    <center><button type="submit" id="btnSolcRequisicao" name="btnSolcRequisicao" onClick="process()" class="btn btn-success toastsDefaultSuccess">Buscar</button></center>
                </div>
            </div>
        </form>
    </div>
