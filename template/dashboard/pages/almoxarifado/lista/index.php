...
<head>
  ...
  <title>SistemaGSG | Lista de Requisições</title>
...
<?php  
    ...
    $SQL_SELECT = "SELECT almox.*, userserv.nome_user FROM `tb_almox` AS almox LEFT JOIN tb_user AS userserv on almox.user=userserv.id_user ORDER BY `requisicao` ASC";
    ...
    <div class="card-body">
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tr>
          ...
          <th><center>DOC. SAP</center></th>
          <th><center>DOC. GSG</center></th>
        </tr>
        </thead>
        <tbody  id="myTable">
        <?php 
        ...
        while ($SQL = $resultado_conexao->fetch(PDO::FETCH_ASSOC)): ?>
                <tr>
                    <td><center><?php echo $SQL['requisicao']; ?></center></td>
                    <td><center><?php echo $SQL['quantidade']; ?></center></td>
                    <td><center><?php echo $SQL['produto']; ?></center></td>
                    <td><center><?php if($SQL['finalizado']==1){echo"Sim";}else{echo"Não";} ?></center></td>
                    <td><center><?php echo $SQL['nome_user']; ?></center></td>
                    <td><center><?php echo $SQL['doc_sap']; ?></center></td>
                    <td><center><?php echo $SQL['doc_gsg']; ?></center></td>
                </tr>
              <?php endwhile; ?>
        </tbody>
        <tfoot>
