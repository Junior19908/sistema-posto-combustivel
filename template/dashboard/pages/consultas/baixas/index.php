      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-compact" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
							<li class="nav-item">
                <a href="pages/consultas/baixas/" class="nav-link active">
...
<!-- /.content-header -->
  ...
  <div class="card card-success">
    ...
    <form name="formCad" action="pdf/index.php" method="post">
      <div class="card-body">
        <div class="form-group">
            <label for="InputCalendario">DRT</label>
            <input type="text" class="form-control" name="MultiplosSelect[]">
        </div>
        <div class="form-group">
