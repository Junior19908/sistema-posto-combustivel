...
<head>
  ...
  <title>SistemaGSG | Backup do Banco de Dados</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-success">
        ...
        <!-- form start -->
        <form role="form" id="export_form" method="post">
            <div class="card-body">
            <?php
            ...
            ?>
              <div class="card-footer">
                <label>
                  <input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $table["Tables_in_sistemagsgposto"];?>">
                <?php echo $table["Tables_in_sistemagsgposto"] ?></label>
              </div>
            <?php
            }
            ?>
                ...
                <div class="card-footer">
                    <button type="submit" id="toastsDefaultSuccess" name="btnBackup" class="btn btn-success toastsDefaultSuccess">Baixar</button>
                </div>
            </div>
        </form>
    </div>
